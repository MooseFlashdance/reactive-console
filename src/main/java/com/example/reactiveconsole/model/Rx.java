...
public class Rx implements Cloneable {
  ...
  private static final List<String> firstNames =
      Arrays.asList(
          "Slab", "Bridge", "Punt", "Butch", "Hold", "Splint", "Flint", "Bolt", "Thick", "Blast",
          "Buff", "Crunch", "Fist", "Stump", "Smash", "Punch", "Buck", "Stump", "Dirk", "Rip",
          "Slate", "Crud", "Brick", "Rip", "Punch", "Gristle", "Slate", "Buff", "Bob", "Blast",
          "Crunch", "Slab", "Lump", "Touch", "Beef", "Big", "Smoke", "Beat", "Hack", "Roll");
